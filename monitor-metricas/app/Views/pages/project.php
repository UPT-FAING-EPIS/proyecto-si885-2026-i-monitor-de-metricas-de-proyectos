...
<html lang="es" class="h-full" data-theme="pm">
  <head>
    ...
    <script id="pmProjectData" type="application/json"><?= (string)json_encode($payload, JSON_UNESCAPED_UNICODE | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?></script>
  </head>
